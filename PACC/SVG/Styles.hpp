		...
		*/
		...
		class StrokeDashArray : public Attribute {
		 public:
			 ...
			 */
			StrokeDashArray(const string &inDashArray) : Attribute("stroke-dasharray", inDashArray) {}
		...
		class StrokeLineCap : public Attribute {
		 ...
		 private:
			...
			StrokeLineCap(const string &inValue) : Attribute("stroke-linecap", inValue) {}
		};
		...
		class StrokeLineJoin : public Attribute {
		 ...
		 private:
			...
			StrokeLineJoin(const string &inValue) : Attribute("stroke-linejoin", inValue) {}
		};
		...
		*/
		...
		class FontFamily : public Attribute {
		 public:
			 ...
			 */
			FontFamily(const string &inName) : Attribute("font-family", inName) {}
		...
		class FontStyle : public Attribute {
		 ...
		 private:
			...
			FontStyle(const string &inName) : Attribute("font-style", inName) {}
		};
		...
		class FontWeight : public Attribute {
		 ...
		 private:
			...
			FontWeight(const string &inName) : Attribute("font-weight", inName) {}
		};
		...
		class TextAnchor : public Attribute {
		 ...
		 private:
			 ...
			 *                 attribute.
			 */
			TextAnchor(const string &inValue) : Attribute("text-anchor", inValue) {}
		};
		...
		class TextDecoration : public Attribute {
		 ...
		 private:
			TextDecoration(const string &inDecoration) : Attribute("text-decoration", inDecoration) {}
		};
